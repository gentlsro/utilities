  ...
  switch (issue.code) {
    case ZodIssueCode.invalid_type:
      if (issue.received === ZodParsedType.undefined) {
        message = t(`${zodKeyPrefix}.errors.invalid_type_received_undefined`, {
          ns,
          defaultValue: message,
          ...path,
        })
      } else {
        message = t(`${zodKeyPrefix}.errors.invalid_type`, {
          expected: t(`${zodKeyPrefix}.types.${issue.expected}`, {
            defaultValue: issue.expected,
            ns,
          }),
          received: t(`${zodKeyPrefix}.types.${issue.received}`, {
    ...
    case ZodIssueCode.invalid_literal:
      message = t(`${zodKeyPrefix}.errors.invalid_literal`, {
    ...
    case ZodIssueCode.unrecognized_keys:
      message = t(`${zodKeyPrefix}.errors.unrecognized_keys`, {
    ...
    case ZodIssueCode.invalid_union:
      message = t(`${zodKeyPrefix}.errors.invalid_union`, {
        ns,
        defaultValue: message,
        ...path,
      })
    ...
    case ZodIssueCode.invalid_union_discriminator:
      message = t(`${zodKeyPrefix}.errors.invalid_union_discriminator`, {
    ...
    case ZodIssueCode.invalid_enum_value:
      message = t(`${zodKeyPrefix}.errors.invalid_enum_value`, {
        options: joinValues(issue.options),
    ...
    case ZodIssueCode.invalid_arguments:
      message = t(`${zodKeyPrefix}.errors.invalid_arguments`, {
        ns,
        defaultValue: message,
        ...path,
      })
    ...
    case ZodIssueCode.invalid_return_type:
      message = t(`${zodKeyPrefix}.errors.invalid_return_type`, {
        ns,
        defaultValue: message,
        ...path,
      })
    ...
    case ZodIssueCode.invalid_date:
      message = t(`${zodKeyPrefix}.errors.invalid_date`, {
        ns,
        defaultValue: message,
        ...path,
      })
    ...
    case ZodIssueCode.invalid_string:
      if (typeof issue.validation === 'object') {
        if ('startsWith' in issue.validation) {
          message = t(`${zodKeyPrefix}.errors.invalid_string.startsWith`, {
          ...
          message = t(`${zodKeyPrefix}.errors.invalid_string.endsWith`, {
        ...
        message = t(
          `${zodKeyPrefix}.errors.invalid_string.${issue.validation}`,
          {
            validation: t(`${zodKeyPrefix}.validations.${issue.validation}`, {
    ...
    case ZodIssueCode.too_small:
      const minimum
        = issue.type === 'date'
          ...
          : issue.minimum
      message = t(
        `${zodKeyPrefix}.errors.too_small.${issue.type}.${
          issue.exact
            ? 'exact'
            : issue.inclusive
              ? 'inclusive'
    ...
    case ZodIssueCode.too_big:
      const maximum
        = issue.type === 'date'
          ...
          : issue.maximum
      message = t(
        `${zodKeyPrefix}.errors.too_big.${issue.type}.${
          issue.exact
            ? 'exact'
            : issue.inclusive
              ? 'inclusive'
    ...
    case ZodIssueCode.invalid_intersection_types:
      message = t(`${zodKeyPrefix}.errors.invalid_intersection_types`, {
        ns,
        defaultValue: message,
        ...path,
      })
    ...
    case ZodIssueCode.not_multiple_of:
      message = t(`${zodKeyPrefix}.errors.not_multiple_of`, {
    ...
    case ZodIssueCode.not_finite:
      message = t(`${zodKeyPrefix}.errors.not_finite`, {
        ns,
        defaultValue: message,
        ...path,
      })
