...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../app/plugins/zod-translation")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin:route-locale-detect' | 'i18n:plugin' | 'nuxt:global-components' | 'i18n:plugin:ssg-detect'
  }
}
