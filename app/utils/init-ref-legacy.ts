...
/**
 * @deprecated VDOM-only. Use Vue useModel(props, key) during the owning
 * component's setup, or pass model refs into stores. Do not infer bindings from VNodes.
 *
 ...
 */
export function initLegacyRef<T extends IItem, K extends keyof T>(payload: {
  defaultValue?: T[K]
  props?: T
  propName: K
